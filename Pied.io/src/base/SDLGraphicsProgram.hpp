...
public:
    ...
    // Constructor
    SDLGraphicsProgram(std::shared_ptr<Level> level, bool editorMode);
    SDLGraphicsProgram(std::shared_ptr<Level> level, int w, int h);
    // Desctructor
    ~SDLGraphicsProgram();
    // Per frame update
    void update();
    ...
    void loadNewLevel(shared_ptr<Level> set);
