...
public:
    ...
    inline static vector<PlatformerBlock> blocks;
    ...
    static std::shared_ptr<Level> loadLevelFromPath(const std::string & filename, std::shared_ptr<Level> level);
